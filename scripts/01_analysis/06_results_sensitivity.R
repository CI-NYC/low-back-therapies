...
version <- "sensitivity" # sensitivity analysis using 7-day allowable gaps
...
ragg::agg_png(
  glue("~/medicaid/low-back-therapies/figures/{Y}/7day_mtp_{Y}_outcome_fix_n_oud_relrisk.png"), 
  width = 7, height = 3.5, units = "cm", res = 600
)
