...
pdf(glue("~/medicaid/low-back-therapies/figures/{version}/risk_differences/{version}_onvsobserved_{Y}.pdf"), width = 7/2.54, height = 3.5/2.54)
...
pdf(glue("~/medicaid/low-back-therapies/figures/{version}/relative_risks/{version}_onvsobserved_{Y}.pdf"), width = 7/2.54, height = 3.5/2.54)
