...
pdf(glue("~/medicaid/low-back-therapies/figures/{version}/risk_differences/{version}_onvsobserved_{Y}.pdf"), width = 5, height = 2.5)
...
pdf(glue("~/medicaid/low-back-therapies/figures/{version}/relative_risks/{version}_onvsobserved_{Y}.pdf"), width = 5, height = 2.5)
