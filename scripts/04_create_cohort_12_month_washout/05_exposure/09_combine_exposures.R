...
previous_treatment <- load_data("previous_treatment.fst", file.path(drv_root_12_month_washout, "exclusion"))
...
mme <- load_data("exposure_max_daily_dose_mme.fst", file.path(drv_root_12_month_washout, "modified_variables"))
days_supply <- load_data("exposure_days_supply.fst", file.path(drv_root_12_month_washout, "modified_variables"))
...
write_data(exposures, "exposures.fst", file.path(drv_root_12_month_washout, "modified_variables"))
