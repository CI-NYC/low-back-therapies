...
write_data(income_codes, "probable_high_income_cal.fst", file.path(drv_root_12_month_washout, "exclusion"))
...
write_data(exclusions, "pain_washout_continuous_enrollment_opioid_requirements_tafdebse_exclusions.fst", file.path(drv_root_12_month_washout, "exclusion"))
