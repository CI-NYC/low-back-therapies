...
mental_ill_icds <- read_csv(file.path(home_dir, "data/public/mental_illness_20230504.csv"), col_names = F) |>
...
write_data(all_mental_ill_clean, "mental_ill.rds", file.path(drv_root_12_month_washout, "baseline_covariates")) # save final data file