...
write.csv(table_one_part1, file = "~/medicaid/low-back-therapies/scripts/00_create_cohort/12_tables/table_one_part1_overall.csv", row.names = FALSE)
write.csv(table_one_part2, file = "~/medicaid/low-back-therapies/scripts/00_create_cohort/12_tables/table_one_part2_overall.csv", row.names = FALSE)
