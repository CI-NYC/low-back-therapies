...
write_data(cohort, "msk_washout_continuous_enrollment_with_exposures.fst", file.path(drv_root, "treatment"))
...
cohort <- load_data("msk_washout_continuous_enrollment_dts.fst", file.path(drv_root, "exclusion"))
