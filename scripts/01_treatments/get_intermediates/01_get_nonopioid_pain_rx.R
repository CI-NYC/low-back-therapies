...
saveRDS(otl, file.path(low_back_dir, "treatments/mediator_otl_nonopioid_pain_rx.rds"))
saveRDS(rxl, file.path(low_back_dir, "treatments/mediator_rxl_nonopioid_pain_rx.rds"))