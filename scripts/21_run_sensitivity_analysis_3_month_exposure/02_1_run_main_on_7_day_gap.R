...
script <- "/home/amh2389/medicaid/low-back-therapies/scripts/21_run_sensitivity_analysis_3_month_exposure/01_lmtp_7_day_gap.R"
...
n_oud_param <- tribble(~subset, ~mediator, ~func, 
                       ...
                       0, "5" , "(x*0) + 1", # "exposure_other_treatment"
