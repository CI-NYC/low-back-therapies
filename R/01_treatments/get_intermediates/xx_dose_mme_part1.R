...
saveRDS(rxl_opioids, file.path(low_back_dir, "treatments/rxl_opioids_pain_mme.rds"))
...
saveRDS(otl_opioids, file.path(low_back_dir, "treatments/otl_opioids_pain_mme.rds"))