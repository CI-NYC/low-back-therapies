...
job_groups <- list(
  ...
  # group9 = c("05_opioid_naive_exclusions.R","05_other_pain_exclusions.R","05_comprehensive_benefits_exclusion.R","05_pregnancy_exclusion.R"),
  # group10 = paste0("06_oud/", c("00_bup.R", "00_hillary.R", "00_methadone.R", "00_poison.R"))
  # group11 = paste0("06_oud/", c("00_poison.R", "00_misuse/01_washout_misuse.R")),
